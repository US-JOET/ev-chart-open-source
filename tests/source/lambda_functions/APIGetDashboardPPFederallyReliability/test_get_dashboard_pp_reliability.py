...
from APIGetDashboardPPReliability.index import handler as api_get_dashboard_program_performance
...
@patch("APIGetDashboardPPReliability.index.aurora")
def test_valid_200_as_jo(
    ...
    official_uptime = response_body.get("official_uptime")
    unofficial_uptime = response_body.get("unofficial_uptime")
    assert official_uptime is not None
    assert "reliability_metrics_available" in official_uptime
    assert "total_ports_with_uptime_activity" in official_uptime
    assert "percentage_ports_not_meeting_uptime_req" in official_uptime
    assert "percentage_ports_meeting_uptime_req" in official_uptime
    assert unofficial_uptime is not None
    assert "reliability_metrics_available" in unofficial_uptime
    assert "total_ports_with_uptime_activity" in unofficial_uptime
    assert "percentage_ports_not_meeting_uptime_req" in unofficial_uptime
    assert "percentage_ports_meeting_uptime_req" in unofficial_uptime
    assert response_body.get("avg_outage") is not None
