...
from APIGetDashboardPPFederallyFundedNetworkSize.index import (
...
@patch("APIGetDashboardPPFederallyFundedNetworkSize.index.aurora")
def test_valid_200_as_jo(
    ...
    assert response_body.get("total_stations") is not None
    assert response_body.get("total_ports") is not None
    assert response_body.get("undefined_ports") is not None
    assert response_body.get("l2_ports") is not None
    assert response_body.get("dcfc_ports") is not None
