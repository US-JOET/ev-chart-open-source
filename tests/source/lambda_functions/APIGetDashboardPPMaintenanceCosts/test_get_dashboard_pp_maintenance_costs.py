...
from APIGetDashboardPPMaintenanceCosts.index import handler as api_get_dashboard_program_performance
...
@patch("APIGetDashboardPPMaintenanceCosts.index.aurora")
def test_valid_200_as_jo(
    ...
    assert "maintenance_cost_metrics_available"in response_body
    assert "monthly_avg_maintenance_repair_cost"in response_body
